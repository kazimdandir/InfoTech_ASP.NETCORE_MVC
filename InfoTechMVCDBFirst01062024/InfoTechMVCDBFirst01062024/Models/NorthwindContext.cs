...
namespace InfoTechMVCDBFirst01062024.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<TestTablo> TestTablos { get; set; } = null!;
        public virtual DbSet<VwDetaySorgu> VwDetaySorgus { get; set; } = null!;
        public virtual DbSet<VwEnCokSatan> VwEnCokSatans { get; set; } = null!;
        public virtual DbSet<VwGetCustomerOrder> VwGetCustomerOrders { get; set; } = null!;
        public virtual DbSet<VwGetProduct> VwGetProducts { get; set; } = null!;
        public virtual DbSet<VwInfoEnCokSatan> VwInfoEnCokSatans { get; set; } = null!;
        public virtual DbSet<VwShipperSpeedyEmpNancy> VwShipperSpeedyEmpNancies { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=KAZIM\\SQLExpress;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TestTablo>(entity =>
            {
                entity.ToTable("TestTablo");
            ...
            modelBuilder.Entity<VwDetaySorgu>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_DetaySorgu");

                entity.Property(e => e.OrderId).HasColumnName("OrderID");
            });

            modelBuilder.Entity<VwEnCokSatan>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_EnCokSatan");
            ...
            modelBuilder.Entity<VwGetCustomerOrder>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_Get_CustomerOrders");
            ...
            modelBuilder.Entity<VwInfoEnCokSatan>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_Info_EnCokSatan");

                entity.Property(e => e.CategoryName).HasMaxLength(15);

                entity.Property(e => e.ProductName).HasMaxLength(40);

                entity.Property(e => e.ToplamSatışAdedi).HasColumnName("Toplam Satış Adedi");
            });

            modelBuilder.Entity<VwShipperSpeedyEmpNancy>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_Shipper_Speedy_EmpNancy");

                entity.Property(e => e.CustomerCompanyName).HasMaxLength(40);
                ...
                entity.Property(e => e.ShipperCompanyName).HasMaxLength(40);
            });
